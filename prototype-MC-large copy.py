# Monte Carlo control version of prototype5.py (converted from Q-learning)
# Saves q-table at the end like the original.
# Reference: original file uploaded by user. :contentReference[oaicite:1]{index=1}
...
DISCOUNT = 0.8  # gamma for returns
